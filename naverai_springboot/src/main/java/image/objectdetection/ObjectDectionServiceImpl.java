...
public class ObjectDectionServiceImpl implements NaverService{
	...
	public String test(String image) {
        ...
        try {
            ...
            if(responseCode==200) { // 네이버 object dection 서버 정상 호출
            ...
            if(br != null) {
                ...
                br.close();
                System.out.println(response.toString()); // 서버와의 결과를 출력(json형태)
            } else {
        ...
        return response.toString(); // 서버 결과 리턴(json형태)
    }
